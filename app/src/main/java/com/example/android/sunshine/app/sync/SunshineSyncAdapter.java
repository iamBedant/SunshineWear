...
//                            (NotificationManagerCompat) getContext().getSystemService(Context.NOTIFICATION_SERVICE);
                    // WEATHER_NOTIFICATION_ID allows you to update the notification later on.
                    mNotificationManager.notify(WEATHER_NOTIFICATION_ID, mBuilder.build());

                    // send data to wearable
                    syncWerable(largeIcon, high, low);
    ...
    // -------------function for sending data to wearable---------------------------
    private void syncWerable(Bitmap largeIcon, double high, double low) {
        Context context = getContext();
        ...
        final String WEATHER_TEMP_HIGH = "weather_temp_high";
        final String WEATHER_TEMP_LOW = "weather_temp_low";
        final String WEATHER_TEMP_ICON = "weather_temp_icon";
        ...
        putDataMapRequest.getDataMap().putString(WEATHER_TEMP_HIGH, Utility.formatTemperature(context, high));
        putDataMapRequest.getDataMap().putString(WEATHER_TEMP_LOW, Utility.formatTemperature(context, low));
        putDataMapRequest.getDataMap().putAsset(WEATHER_TEMP_ICON, asset);
